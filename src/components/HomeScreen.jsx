...
const HomeScreen = () => {
  return (
    <VStack spacing={10} align="center" mt={10}>
      ...
      <Text fontFamily="mono" fontSize="18px" fontWeight="bold" mb="-20px" mr="220px">GND</Text>

      <Text fontFamily="mono" fontSize="16px" fontWeight="bold" mb="-20px">vol.1</Text>
      <Text fontFamily="mono" fontSize="16px" fontWeight="bold" ml="220px">SEOUL</Text>

      <InputCode />
      
      <Text fontFamily="noto" fontSize="md" textAlign="center" mt="20px">
      ...
      <Link href="tel:010-8288-3951" textDecoration="none">
          <Text fontFamily="noto" fontSize="10px" textAlign="center" mt="-10px">
            문의 010-8288-3951
          </Text>
        </Link>
      <Text mb="100px"></Text>
