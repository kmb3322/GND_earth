...
export default function StartHomePage() {
  ...
  const people = [
    ...
    },
    {
      name: '김민범',
      role: '영상 총괄 · UX 리서치',
      desc: ['KAIST 전산학부 23학번', 'KAIST HCI 연구실 KIXLAB Intern', "대전 대학가요제 '태울뮤직페스티벌 (2024.05.22)' 총감독", 'KAIST 방송국 VOK 소속 활동, 학교 홍보 영상 · 신입생 환영 영상 제작', '전국 단위 단편영화제 및 공모전 다수 수상'],
    },
  ];
      ...
      >
        <VStack spacing={6} maxW="900px" mx="auto" px={4}>
          ...
          <AnimatePresence> 
            ...
            mb={10}
          >
            약 200명의 아티스트와 함께 한, 음악과 전시 예술의 환상적 결합.<br/> GND vol.1을 만나보세요.
          </Text>
          </AnimatePresence>
